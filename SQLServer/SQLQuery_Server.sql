...
INSERT INTO TELEFONE VALUES ('CEL','7899889',2)
GO
...
/* 3 PASSO  - RETORNO EM INTEIRO + OPR MATEMATICA*/
...
FROM ALUNO
GO
SELECT NOME, DATENAME(WEEKDAY, NASCIMENTO) AS DIA_NASC
FROM ALUNO
GO

/* DATEPART - POREM O RETORNO É UM INTEIRO */
SELECT NOME,DATEPART(MONTH,NASCIMENTO)AS MES, DATENAME(MONTH,NASCIMENTO) AS MES_NASC
FROM ALUNO
GO
/* DATEANO - RETORNA UMA DARA SOMANDO A OUTRA DATA */

SELECT DATEADD(DAY, 365, GETDATE())

SELECT DATEADD(YEAR, 10, GETDATE())

/* CONVERSAO DE DADOS - STRING P/ NUM -> AUTO - NUM P STRING - NÃO */ 
...
FROM 'C:\Users\Sanmartin\Desktop\AULAS SQL SERVER\CONTAS.txt'
WITH
(
	FIRSTROW = 2,
	DATAFILETYPE = 'CHAR',
...
/* DESAFIO DO SALDO - QUERY QUE TRAGA O NUMERO DA CONTA E SALDO DEVEDOR OU CREDOR */
...
INSERT INTO PRODUTOS VALUES('NOTEBOOK I6','COMPUTADORES',3150.00)
INSERT INTO PRODUTOS VALUES('LIVRO BUSINESS INTELLIGENCE','LIVROS',50.00)
GO
...
AS
		...
		-- PRIMEIRO BLOCO - VALORES VINDO DE TABELAS SAO INSERIDO COM O COMANDO SELECT
		...
		--SEGUNDO BLOCO - VALORES VINDOS DE FUNCOES OU VALORES LITERAIS DEVEM SER ATRIBUIDOS COM O COMANDO SET
		SET @DATA = GETDATE()
		SET @USUARIO = SUSER_NAME()
		SET @ACAO = 'VALOR ISERIDO PELA TRIGGER TRG_ATUALIZA_PRECO'
...
/* PROGAMANDO TRIGGER EM UMA COLUNA */
...
DECLARE
		...
		SET @RESULTADO = (SELECT 50+50)
		INSERT INTO RESULTADO VALUES (@RESULTADO)
		PRINT 'VALOR INSERIODO NA TABELA: ' + CAST(@RESULTADO AS VARCHAR)
		GO
...
/* TRAZER  OS TELEFONES DE ACORDO COM O TIPO PASSADOS */
...
/* CRIANDO PROCEDURE COM PARAMETROS DE ENTRADA E OUPUT */
...
/* EXECUCAO DA PROC COM PARAMETROS DE OUPUT */

/* TSQL = TRANSCACTION SQL -> LINGUAGEM QUE O SQL TRABALHA */
...
GO
EXEC CADASTRO 'JORGE','M','1981-01-01','CEL','987854288'
GO
...
ON IDPESSOA = ID_PESSOA
GO
/* TSQ É UM BLOCO DE LINGUAGEM DE PROGRAMACAO.
PROGRAMAS SAO UNIDADES QUE PODEM SER CHAMADAS DE BLOCO ANONIMOS. BLOCOS ANONIMOS NAO RECEBEM
NOME, POIS NAO SAO SALVOS NO BANCO. CRIAMOS BLOCOS ANONIMOS QUANDO IREMOS EXECUTA-LOS UMA SO VEZ
OU TESTAR ALGO. */
...
BEGIN
		...
		PRINT 'VALOR NUMERICO: ' + CONVERT(VARCHAR,@V_NUMERO) --QUANDO TRABALHAR COM DATA
		...
		PRINT 'VALOR DE DATA: ' + CONVERT(VARCHAR,@V_DATA,105)  -- 105 FORMATO PTBR
END
GO
...
DECLARE 
		@NUMERO INT =5
BEGIN
		IF @NUMERO = 4 -- EXPRESSAO  BOOLEANA
...
DECLARE 
		@CONTADOR INT
BEGIN
		SELECT -- O CASO REPRESENTA UMA COLUNA
		CASE 
...
CREATE PROC GETNUMBER @NUMERO INT
AS		
BEGIN
...
BEGIN 
		WHILE (@I <15)
		BEGIN
			PRINT ' O VALOR DE @I= ' + CAST(@I AS VARCHAR)
			SET @I = @I +1
		END
END
GO